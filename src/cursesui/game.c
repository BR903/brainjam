/* cursesui/game.c: the game display.
 */
 ...
 */
void cursesui_rendergame(renderparams const *params)
{
    if (validatesize())
 ...
 * up to the caller.
 */
command_t cursesui_getinput(void)
{
    command_t cmd;
 ...
 */
int cursesui_setshowkeyguidesflag(int flag)
{
    showkeyguides = flag;
    return flag;
}
 ...
 */
int cursesui_setcardanimationflag(int flag)
{
    (void)flag;
    return FALSE;
}
 ...
 */
void cursesui_movecard(gameplayinfo const *gameplay, card_t card,
