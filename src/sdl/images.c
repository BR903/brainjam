 ...
 * using values defined in sdl/alertids.h and sdl/labelids.h, and are
 * located via the SDL_Rect arrays defined below.
 */
INCBIN("sdl/alerts.png", pngalerts, pngalerts_end);
INCBIN("sdl/labels.png", pnglabels, pnglabels_end);
