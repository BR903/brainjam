/* sdlui/internal.h: all functions and data internal to the SDL UI module.
 */

#ifndef _sdlui_internal_h_
#define _sdlui_internal_h_
...
/* The graphic rendering information global, defined in sdlui.c
 */
extern graphicinfo _graph;

/*
 * Functions defined in sdlui.c.
 */
 ...
 * inside of sdlui.c.) See ./ui.h for descriptions of these functions.
 */

/* Defined in game.c.
 */
extern int sdlui_setshowkeyguidesflag(int flag);
extern int sdlui_setcardanimationflag(int flag);
...
/* Defined in help.c.
 */
extern void sdlui_addhelpsection(char const *title, char const *text,
                                 int placefirst);
